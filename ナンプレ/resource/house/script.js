    ...
    const keywordResponses = {
        "パズル": "パズルって時の流れを忘れられて楽しいですよね。左のメニューから遊べますよ、面白いのがたくさんありますから。",
        "リリィ": "なんですか……？私のこと呼びました……？ ",
        "こんにちは": "こんにちは。いい天気(?)ですね。",
        "工事": "そうなんです、あちこち工事中で……。見苦しくてすみません……。",
        "好き": "えっ……！？ あ、ありがとうございます……？すこしビックリしました……。",
        ...
        "クロスワード": "クロスワードを見つけたんですか？どこかに使いそうな単語が列挙されているページはありませんかね……。",
        "スケルトン": "クロスワードを見つけたんですか？どこかに使いそうな単語が列挙されているページはありませんかね……。",
        "readme": "……あ！見つけました！！このサイトが公開されているGithubのREADMEを見れば何か新しい情報を見れるかもしれないです！https://github.com/negisalt/OriginalNumberPlace ここにアクセスしてみてください。"
    };
